        ...
        return (
            <div>
                ...
                <div className="graafi">
                    <ColumnChart title="Exercise duration" download={true} width="100%" ytitle="minutes" data={graafiKestavyysAika}
                                 messages={{empty: "No data yet! (You can do it!)"}}/>
                </div>
                <div className="graafi">
                    <ColumnChart title="Exercise distance" download={true} width="100%" ytitle="Kilometers" data={graafiKestavyysMatka}
                                 messages={{empty: "No data yet! (You can do it!)"}}/>
                </div>
            </div>
